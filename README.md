...
(si consiglia la visione della relazione tramite il file pdf README.pdf)
...
2) Attende il segnale ([[readme#5.7 Comunicazione tra Processi|5.7]]) di `TICKET_REQ`, controlla la disponibilità del servizio ed eroga il biglietto.
