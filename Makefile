...
PROJ_DEPS = build/utils.o build/config.o build/sem.o build/msg.o build/shm.o build/ftok_key.o build/sig_utils.o
...
bin/calendar_main: build/calendar_main.o build/sem_utils.o build/seats.o $(PROJ_DEPS)
	$(CC) $(CFLAGS) -o bin/calendar_main build/calendar_main.o build/sem_utils.o build/seats.o $(PROJ_DEPS)
